...
{
    public static final String ACTION_SHOW_TAG = "org.artags.android.widget.SHOW_TAG";
    ...
    public static final String LOG_TAG = "ARTagsTV";
    public static final String[] CATEGORIES = { "Best tags" , "Latest tags" };
